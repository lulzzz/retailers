  ...
  function h(a){this.extend(h,google.maps.OverlayView);this.b=[];this.d=null;this.g=100;this.m=!1;a=a||{};void 0==a.backgroundColor&&(a.backgroundColor=this.A);void 0==a.borderColor&&(a.borderColor=this.B);void 0==a.borderRadius&&(a.borderRadius=this.C);void 0==a.borderWidth&&(a.borderWidth=this.D);void 0==a.padding&&(a.padding=this.H);void 0==a.arrowPosition&&(a.arrowPosition=this.u);void 0==a.disableAutoPan&&(a.disableAutoPan=!1);void 0==a.disableAnimation&&(a.disableAnimation=!1);void 0==a.minWidth&&(a.minWidth=
    ...
    h.prototype.draw=function(){var a=this.getProjection();if(a){var c=this.get("position");if(c){var d=0;this.d&&(d=this.d.offsetHeight);var e=D(this),f=n(this),k=parseInt(this.get("arrowPosition"),10)||0,k=k/100,a=a.fromLatLngToDivPixel(c),c=this.e.offsetWidth,g=this.c.offsetHeight;if(c){g=a.y-(g+f);e&&(g-=e);var l=a.x-c*k;this.c.style.top=t(g);this.c.style.left=t(l);switch(parseInt(this.get("shadowStyle"),10)){case 1:this.a.style.top=t(g+d-1);this.a.style.left=t(l);this.a.style.width=t(c);this.a.style.height=
      ...
      (function() {
        ...
        *
        * env, mapElement, geoLat, geoLng, domain, locations, page, key
        */

        retailers.map = function (settings) {

          if (document.getElementById(settings.element)){
            ...
            */
            retailers.json = function(url) {
              ...
              .then(function(xhr, response) {
                ...
                retailers.shop(
                  element.retailer.closest('li').first().data('latitude'),
                  element.retailer.closest('li').first().data('longitude'),
                  element.retailer.closest('li').first().data('country_code'),
              ...
              .complete(function() {
                ...
                var element = {
                  ...
                  retailer  : $('li[data-map="retailer"]'),
                  li        : $('.list > li'),
                  distance  : $('.distance').first().text(),
                  locate    : $('button[data-locator="button"]'),
                  icon      : $('i[data-locator="icon"]')
                };

                var notify = {
                  nearest  : $('<div>Your nearest Retailer is <b>'+element.distance+' km</b> away!</div>'),
                  located  : $('<div>Use Geolocate for an accurate distance!</div>'),
                  locating : $('<div>Acquiring Location. Please wait.</div>'),
            ...
            *
            */
            retailers.shop = function (latitude, longitude, iso, retailer_name, logo) {

              if(logo) {
                var shop_logo = '<img src="'+logo+'">';
              } else {
                var shop_logo = '<h2>'+retailer_name+'</h2>';
              }

              var template = {

                bubble : '<div class="info-window"><div class="sticker" data-map="sticker"><div class="logo">'+shop_logo+'</div><div class="store"><img src="https://maps.googleapis.com/maps/api/streetview?size=300x150&location='+latitude+','+longitude+'&heading=151.78&pitch=-0.76&key='+settings.api_key+'"></div></div></div>',

                oigm  : '<div class="oigm"><a class="oigm-btn" href="https://maps.google.com/?saddr='+store.get('latitude')+','+store.get('longitude')+'&daddr='+latitude+','+longitude+'"><i class="re-icon re-icon-g-maps"></i>&nbsp; Open in Google Maps</a></div>'
              };
              ...
              geocoding.geocode({'location': element.latlng}, function(results, status) {
                if (status === 'OK') {
                  ...
                  infobubble.setContent(template.bubble);
                  ...
                  if (store.get('geolocate') && element.locator_icon.hasClass('re-icon-locator')) {
                    element.locator_icon.toggleClass('re-icon-locator re-icon-location_full');
                  } else {
                    element.locator_icon.removeClass('blink');
                  }
            ...
            retailers.loading = function (state) {
              ...
              if(state == 'hide') {
                ...
                alert('Error! No loading state found!');
              }
