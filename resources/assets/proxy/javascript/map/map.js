            ...
            */
            retailers.shop = function (latitude, longitude, iso, retailer_name, logo) {
              ...
              var template = {
                ...
                bubble : '<div class="info-window"><div class="sticker" data-map="sticker"><div class="logo">'+shop_logo+'</div><div class="store"><img src="https://maps.googleapis.com/maps/api/streetview?size=400x200&location='+latitude+','+longitude+'&heading=151.78&pitch=-0.76&key='+settings.api_key+'"></div></div></div>',
